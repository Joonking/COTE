...
| 2025-11-19 | 백준 | 2512 | 예산 | 실버 2 | 이분탐색 |
...
<details open>
<summary><b>2025-11-19</b></summary>

- ✅ **이분탐색 문제(2512) 성공!** - **이분탐색 4연속 성공 🔥**
  - **성장 포인트**:
    - ① 1654(랜선 자르기)에서 배운 `long long` 타입 처리를 즉시 적용
    - ② 엣지 케이스(`totalRequest <= M`) 미리 처리하는 습관 형성
    - ③ 매개변수 탐색 패턴(조건 만족하는 최댓값 찾기)을 완벽히 이해
    - ④ 변수명(`countries` → `budgets`) 개선 제안 수용
  - **핵심 개념 재확인**:
    - 이분탐색 범위 설정: `left = 0`, `right = maxBudget`
    - 조건 만족 시: `ans` 갱신 후 `left = mid + 1` (더 큰 값 탐색)
    - 조건 불만족 시: `right = mid - 1` (더 작은 값 탐색)
  - **이분탐색 진척**: 6개 → 7개 (목표 20개 중 35% 달성!)
  - **연속 성공**: 1920 → 2805 → 1654 → 2512 (실버4 → 실버2 난이도 상승 중)

</details>

<details open>
<summary><b>2025-11-18</b></summary>
...
<details open>
<summary><b>2025-11-17</b></summary>
...
<details>
<summary><b>2025-11-16</b></summary>
...
<details>
<summary><b>2025-11-15</b></summary>
...
<details>
<summary><b>2025-11-14</b></summary>
